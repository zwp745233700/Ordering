...
<html>
	...
	<body class="main">
		...
		<div class="login1">
			<h3 class="font1">商家帐号登录 </h3>
            <div class="login2">
            	
                <form id="login_form" action="${pageContext.request.contextPath }/shore/login" method="post">
	                                        商家用户名：<input type="text" id="username" name="username"  placeholder="输入用户名" /><br/>
	                    <div></div>
	                   	账号密  &nbsp;  码：<input type="password" id="password" name="password" placeholder="输入密码"/><br/>
                  ...
                  <div>
                  	<span>还没有帐号？</span><a href="${pageContext.request.contextPath }/shore//toshoreRegister">立即注册</a>
               	  </div>
         	  </div>
       	  </div>
  </body>
